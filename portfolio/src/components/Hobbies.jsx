...
export default function Hobbies({ hobbies }) {
  ...
  const getHobbyColor = (idx) => {
    const colors = [
      ...
      { bg: `${themeColors.primary}15`, border: `${themeColors.primary}30`, text: themeColors.primaryDark },
      { bg: `${themeColors.primary}10`, border: `${themeColors.primary}25`, text: themeColors.primaryDark },
      { bg: `${themeColors.primary}10`, border: `${themeColors.primary}25`, text: themeColors.primaryDark },
      { bg: `${themeColors.primary}20`, border: `${themeColors.primary}35`, text: themeColors.primaryDark },
      { bg: `${themeColors.primary}20`, border: `${themeColors.primary}35`, text: themeColors.primaryDark },
    ];
