        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div
            ...
            style={{ 
              borderColor: themeColors.border,
              backgroundColor: themeColors.cardBg,
              boxShadow: `0 12px 35px ${themeColors.primary}05`,
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = `0 20px 45px ${themeColors.primary}20`;
              e.currentTarget.style.borderColor = themeColors.primary;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = `0 12px 35px ${themeColors.primary}05`;
              e.currentTarget.style.borderColor = themeColors.border;
            }}
          >
            <div className="flex h-full flex-col justify-center">
              ...
              <ul className="space-y-3 text-sm" style={{ color: themeColors.textSecondary }}>
                <li className="flex gap-3 leading-relaxed transition-all duration-200 hover:translate-x-1">
                  <span className="transition-transform duration-200 group-hover:scale-125" style={{ color: themeColors.primaryDark }}>✓</span>
              ...
              <div 
                className="mt-6 h-0.5 w-12 rounded-full transition-all duration-300 group-hover:w-full group-hover:h-1"
                style={{ backgroundColor: `${themeColors.primaryDark}30` }}
              />
            </div>
          </div>
